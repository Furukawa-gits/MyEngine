...
#pragma region プレイヤーの通常弾と敵本体の当たり判定
	...
	/// <param name="bulletsList">プレイヤーの通常弾</param>
	/// <param name="enemys">敵(群れ)</param>
	static void checkBulletEnemys(list<unique_ptr<bullet>>* bulletsList, list<unique_ptr<Enemy>>* enemys);
#pragma endregion 
...
#pragma region プレイヤーの通常弾と敵の弾の当たり判定
	...
	/// <param name="bulletsList">プレイヤーの通常弾</param>
	/// <param name="enemys">敵(群れ)</param>
	static void checkBulletEnemyBullets(list<unique_ptr<bullet>>* bulletsList, list<unique_ptr<Enemy>>* enemys);
#pragma endregion 
...
#pragma region プレイヤーの追尾弾と敵本体の当たり判定
	...
	static void checkHomingEnemy(list<unique_ptr<Missile>>* missilesList);
#pragma endregion
